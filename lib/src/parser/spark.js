...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "antlr4", "antlr4/error", "../../antlr/spark/output/sparkLexer", "../../antlr/spark/output/sparkParser", "../../antlr/spark/output/sparkVisitor", "../utils/index"], factory);
    }
    ...
    var SparkErrorListener = /** @class */ (function (_super) {
        ...
        function SparkErrorListener(errorlistener) {
    ...
    var parserSingle = function (sql, errorListener, visitor) {
        ...
        if (errorListener) {
            var listener = new SparkErrorListener(errorListener);
